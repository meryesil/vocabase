...
async function handleRegister() {
  if (password.value.length < 6) {
    auth.error = 'Güvenliğiniz için şifreniz en az 6 karakterden oluşmalıdır.'
    return
  }
  ...
  <div class="page auth-page">
    <div class="container auth-container">
      <div class="auth-card glass-card">
        <RouterLink to="/" class="auth-logo">
          <div class="logo-icon custom-logo">
            <svg viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
              <rect width="36" height="36" rx="10" fill="url(#vb-pro-bg-reg)"/>
              ...
              <path d="M18 7 L20.8 10 L18 13 L15.2 10 L18 7 Z" fill="url(#vb-diamond-grad-reg)"/>
              <defs>
                <linearGradient id="vb-pro-bg-reg" x1="0" y1="0" x2="36" y2="36" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#0F172A"/>
                  <stop offset="0.5" stop-color="#1E1E2E"/>
                  <stop offset="1" stop-color="#311042"/>
                </linearGradient>
                <linearGradient id="vb-v-grad-reg" x1="9" y1="10" x2="27" y2="26" gradientUnits="userSpaceOnUse">
                  <stop stop-color="#818CF8"/>
                  <stop offset="0.6" stop-color="#C084FC"/>
                  <stop offset="1" stop-color="#E879F9"/>
                </linearGradient>
                <linearGradient id="vb-diamond-grad-reg" x1="15" y1="7" x2="21" y2="13" gradientUnits="userSpaceOnUse">
        ...
        <h1>Hesap oluştur</h1>
        <p class="auth-sub">Ücretsiz kayıt ol, kelime yolculuğuna başla.</p>
        ...
        <form @submit.prevent="handleRegister" class="auth-form">
          ...
          <div class="form-group">
            ...
            <span class="password-hint">💡 Şifreniz en az 6 karakter olmalı (harf, rakam vb. içerebilir).</span>
          </div>

          <p v-if="auth.error" class="error-msg">{{ auth.error }}</p>

          <button type="submit" class="btn btn-primary btn-full" :disabled="auth.loading">
            {{ auth.loading ? 'Kayıt yapılıyor...' : 'Kayıt Ol' }}
          </button>
        </form>
